...
const Color kPrimaryColor = Color(0xFF274198);
const Color kPrimaryLightColor = Color(0xFFE1E7FF);
   const Color kGreyText = Color(0xFF6C6C6C);
const Gradient scaffoldGradient = LinearGradient(
